...
import { 
  ...
  HiBookOpen, 
  HiAcademicCap, 
  HiCloudArrowDown,     // FIX
  HiChartBar,
  HiClock,
  HiDevicePhoneMobile,  // FIX
  HiUserGroup,
  ...
  return (
    <>
      <SeoHead
        ...
        description="Join CPS E-Learning for HD video lectures, live classes, mock tests, and digital study material for HPAS, HAS, and government exams. Learn anytime, anywhere."
        canonical="https://www.thecareerspathway.com/e-learning"
        keywords="HPAS online classes, HAS video lectures, e-learning platform, online coaching, CPS digital classes"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                CPS <span className="text-yellow-300">E-Learning</span> Platform
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Why Choose <span className="text-blue-600">CPS E-Learning</span>?
            </h2>
      ...
      {/* DEMO VIDEO SECTION */}
      <section id="demo" className="py-20 bg-linear-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Experience Our <span className="text-blue-600">Teaching Quality</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
              <div className="aspect-video bg-linear-to-br from-blue-500 to-blue-700 flex items-center justify-center relative">
                <div className="text-center text-white">
                  ...
                  <p className="text-blue-200 mt-2">Introduction to Himachal Administration</p>
                </div>
                {/* Play button overlay */}
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">What You'll Learn in This Lecture</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
                  <div className="flex items-center">
                    <HiStar className="w-5 h-5 text-green-500 mr-3 shrink-0" />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Featured <span className="text-blue-600">Online Courses</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            {courses.map((course, index) => (
              <div 
                ...
                className={`bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 ${
                  course.featured ? 'border-yellow-400 border-2' : 'border-gray-100'
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex items-center text-gray-600">
                      <HiVideoCamera className="w-5 h-5 text-blue-600 mr-3" />
                      <span><strong>Lectures:</strong> {course.lectures}</span>
                    </div>
                    <div className="flex items-center text-gray-600">
                      <HiClipboardDocumentList className="w-5 h-5 text-blue-600 mr-3" />
                      <span><strong>Tests:</strong> {course.tests}</span>
                    </div>
                    <div className="flex items-center text-gray-600">
                      <HiAcademicCap className="w-5 h-5 text-blue-600 mr-3" />
                  ...
                  <div className="mb-6">
                    <div className="flex items-baseline gap-2">
                      ...
                      {course.featured && (
                        <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-sm font-semibold ml-auto">
                          Save ₹10,000
                        </span>
                      )}
                    </div>
                  ...
                  <Link
                    href="/e-enrollment"
                    className="w-full bg-linear-to-r from-blue-600 to-blue-700 text-white py-4 rounded-xl font-bold text-lg flex items-center justify-center hover:shadow-lg transition-all duration-300 transform hover:scale-105 group"
                  >
                    Enroll Now
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Learn <span className="text-blue-600">Anytime, Anywhere</span>
              </h2>
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Self-Paced Learning</h4>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Learn from experienced HPAS/HAS faculty and retired administrators</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    <HiQuestionMarkCircle className="w-6 h-6 text-green-500 mt-1 shrink-0" />
                    <div>
                      <h4 className="font-bold text-gray-900 mb-1">Doubt Support</h4>
                      <p className="text-gray-600">24/7 doubt resolution through dedicated support system</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-blue-50 rounded-xl">
                  <span className="font-semibold text-gray-900">Video Quality</span>
                  <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-semibold">HD 1080p</span>
                </div>
                <div className="flex items-center justify-between p-4 bg-green-50 rounded-xl">
                  <span className="font-semibold text-gray-900">Device Support</span>
                  <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-semibold">Mobile & Desktop</span>
                </div>
                <div className="flex items-center justify-between p-4 bg-purple-50 rounded-xl">
                  <span className="font-semibold text-gray-900">Download Access</span>
                ...
                <div className="flex items-center justify-between p-4 bg-orange-50 rounded-xl">
                  ...
                  <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-semibold">Provided</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-linear-to-r from-blue-600 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Start Your <span className="text-yellow-300">Online Learning</span> Journey Today!
          </h2>
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
